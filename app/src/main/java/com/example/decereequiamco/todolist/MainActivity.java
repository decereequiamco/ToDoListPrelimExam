...
public class MainActivity extends AppCompatActivity {
    ...
    private static final String TA = getCurrentTimeStamp();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // 3
        setContentView(com.example.decereequiamco.todolist.R.layout.activity_main);

        // 4
        mDateTimeTextView = (TextView) findViewById(com.example.decereequiamco.todolist.R.id.dateTimeTextView);
        final Button addTaskBtn = (Button) findViewById(com.example.decereequiamco.todolist.R.id.addTaskBtn);
        final ListView listview = (ListView) findViewById(com.example.decereequiamco.todolist.R.id.taskListview);
    ...
    private void taskSelected(final int position) {
        ...
        // 2
        alertDialogBuilder.setTitle(com.example.decereequiamco.todolist.R.string.alert_title);


        // 3
        alertDialogBuilder
                .setMessage(mList.get(position))
                .setPositiveButton(com.example.decereequiamco.todolist.R.string.delete, new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int id) {
                        mList.remove(position);
                        mAdapter.notifyDataSetChanged();
                    }
                })
                .setNegativeButton(com.example.decereequiamco.todolist.R.string.cancel, new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int id) {
                        dialog.cancel();
                    }
                });
